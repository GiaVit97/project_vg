...
if args.test_only:
    model_folder = join(args.model_folder, "best_model.pth")
else:
    model_folder = join(args.output_folder, "best_model.pth")
#### Test best model on test set
best_model_state_dict = torch.load(model_folder)["model_state_dict"]
